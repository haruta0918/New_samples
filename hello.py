...
json_load = json.load(json_open)
d.extend(
     {"LAT":json_load[2]['geoData']['latitude'], "LON":json_load[2]['geoData']['longitude'], "SIZE": 0.5, "COLOR": [0, 0, 255, 100]},
)

st.map(d[2], latitude="LAT", longitude="LON", size="SIZE", color="COLOR", zoom=15)
print(d)